...
import { ensureEmailIsValidy } from "../middlewares/ensureEmailValidy.middleware";
...
userRoutes.post('',ensureEmailIsValidy ,ensureDataIsValid(userSerializer) ,createUserController)
